...
@Component({
  ...
  templateUrl: './largo-documental.component.html',
  styleUrl: './largo-documental.component.css'
})
export class LargoDocumentalComponent {
  ...
  getData() {
    const url = `${environment.apiUrl}/list_lardoc`;
