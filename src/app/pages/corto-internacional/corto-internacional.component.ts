...
@Component({
  selector: 'app-corto-internacional',
  standalone: true,
  imports: [
    CronogramaComponent,
    MatButtonModule,
  ...
  templateUrl: './corto-internacional.component.html',
  styleUrl: './corto-internacional.component.css'
})
export class CortoInternacionalComponent {
  ...
  getData() {
    const url = `${environment.apiUrl}/list_cortointer`;
