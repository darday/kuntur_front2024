...
@Component({
  selector: 'app-corto-univ-documental',
  standalone: true,
  imports: [
    CronogramaComponent,
    MatButtonModule,
  ...
  templateUrl: './corto-univ-documental.component.html',
  styleUrl: './corto-univ-documental.component.css'
})
export class CortoUnivDocumentalComponent {
  ...
  getData() {
    const url = `${environment.apiUrl}/list_cortounidoc`;
